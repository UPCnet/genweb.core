...
(function() {
    ...
    tinymce.create('tinymce.plugins.GwInteractiveTemplatesPlugin', {
        init : function(ed, url) {
            var t = this;
            t.editor = ed;
            ...
            // Register commands
            ed.addCommand('mceGwInteractiveTemplates', function(ui) {
                ed.windowManager.open({
                    file : url + '/interactive_template.htm',
                    width : ed.getParam('template_popup_width', 750),
                    height : ed.getParam('template_popup_height', 600),
                    inline : 1
                }, {
            ...
            ed.addCommand('mceGwInsertInteractiveTemplate', t._insertTemplate, t);

            // Register buttons: afegeix el botó a la botonera del tiny
            ed.addButton('gwinteractivetemplates', {title : 'template.desc', cmd : 'mceGwInteractiveTemplates'});
        },
    ...
    tinymce.PluginManager.add('gwinteractivetemplates', tinymce.plugins.GwInteractiveTemplatesPlugin);
})();
