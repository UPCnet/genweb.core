...
<h2>Bàners</h2>
<p><a href="#"><img alt="mostra" src="++genweb++static/example-images/banerMostra1linia_gw3.png" /></a> <a href="#"><img alt="mostra" src="++genweb++static/example-images/banerMostra1linia_gw3.png" /></a></p>
<div class="row-fluid">
...
<thead>
<tr><th>#</th><th>Columna 1</th><th class="error">Columna 2</th><th>Columna 3</th><th>Columna 4</th><th>Columna 5</th><th>Columna 6</th></tr>
</thead>
<tfoot>
<tr>
...
<table summary="Detall d'estructura de la taula de registres"><caption>Taula registres</caption>
<tbody>
<tr class="cap">
<td>Item A</td>
<td>Item B</td>
