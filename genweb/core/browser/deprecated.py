""" This module contains all the code related to deprecated and no longer used """
...
def migracio3(context):
    """Funcio que realitza la migracio de GW3 a GW4 (deprecated)"""
...
class migracioView(BrowserView):
    """Vista principal que s'ocupa de la migracio (deprecated)"""
